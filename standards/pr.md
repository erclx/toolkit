...
- `## Technical Context` _(optional)_: 1-2 lines of architectural reasoning explaining why, not what; omit for docs, config, or trivial changes; use bullet points when multiple reasons, single sentence acceptable when only one
