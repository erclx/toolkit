Audit the files listed in the context map against the source of truth provided.

For each file in the context map:

1. Locate and read the equivalent file in the current project
